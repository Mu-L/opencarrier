...
//! - `build_agent_card` — expose Carrier agents via A2A
...
pub struct AgentCard {
    ...
    /// Skills this agent can perform (A2A skill descriptors, not Carrier skills).
...
/// A2A skill descriptor (not an Carrier skill — describes a capability).
#[derive(Debug, Clone, Serialize, Deserialize)]
...
// ---------------------------------------------------------------------------
// A2A Server — expose Carrier agents via A2A
// ---------------------------------------------------------------------------

/// Build an A2A Agent Card from an Carrier agent manifest.
