...
use carrier_types::brain::{ApiFormat, AuthHeaderType, EndpointReport};
...
///
/// Implemented by `carrier_kernel::brain::Brain`.
#[async_trait]
pub trait Brain: Send + Sync {
    ...
    fn credentials_for(
        &self,
        _provider: &str,
    ) -> Option<carrier_types::brain::ProviderCredentials> {
        None
    }
