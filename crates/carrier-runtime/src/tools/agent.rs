...
fn parse_entity_type(s: &str) -> carrier_types::memory::EntityType {
    use carrier_types::memory::EntityType;
...
fn parse_relation_type(s: &str) -> carrier_types::memory::RelationType {
    use carrier_types::memory::RelationType;
    match s.to_lowercase().as_str() {
...
async fn tool_knowledge_add_entity(
    ...
    let entity = carrier_types::memory::Entity {
...
async fn tool_knowledge_add_relation(
    ...
    let relation = carrier_types::memory::Relation {
...
async fn tool_knowledge_query(
    ...
    let pattern = carrier_types::memory::GraphPattern {
        source,
        relation,
        target,
        max_depth,
