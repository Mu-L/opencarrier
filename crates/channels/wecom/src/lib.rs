//! WeChat Work (WeCom) channel adapter.
//!
//! Provides:
...
//! - `register_and_start_smartbot` — dynamically register and start a smartbot channel
...
impl Channel for WeComAppKfWatcher {
...
impl Channel for WeComSmartBotWatcher {
    fn channel_type(&self) -> &str {
        "wecom_smartbot"
    }
