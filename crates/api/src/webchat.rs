...
const ETAG: &str = concat!("\"carrier-", env!("CARGO_PKG_VERSION"), "\"");
...
/// GET / — Serve the Carrier Dashboard single-page application.
///
...
/// The embedded HTML/CSS/JS for the Carrier Dashboard.
///
