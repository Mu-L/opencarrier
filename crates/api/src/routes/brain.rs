        ...
        Err(_) => {
            return (
                ...
                Json(serde_json::json!({"error": format!(
                    "Invalid format '{}'. Supported: openai, anthropic, gemini, dashscope_tts, dashscope_image, dashscope_video, kling, openai_images, minimax_image, minimax_search, glm_search",
                    format_str
                )})),
            )
        }
