        ...
        match state.kernel.verify_signed_manifest(signed_json) {
            ...
            Err(e) => {
                ...
                state.kernel.audit_log.record(
                    "system",
                    runtime::audit::AuditAction::AuthAttempt,
...
pub async fn restart_agent(
    ...
    let _ = state
        .kernel
        .registry
        .set_state(agent_id, types::agent::AgentState::Running);
...
pub async fn get_agent(
    ...
    (
        ...
        Json(serde_json::json!({
            ...
            "skills": entry.manifest.flows,
            "skills_mode": if entry.manifest.flows.is_empty() { "all" } else { "allowlist" },
...
pub async fn suspend_agent(
    ...
    if let Err(e) = state
        .kernel
        .registry
        .set_state(agent_id, types::agent::AgentState::Suspended)
    {
        return (
            StatusCode::INTERNAL_SERVER_ERROR,
            Json(serde_json::json!({"error": format!("{e}")})),
