...
fn test_chat_request_fields_match() {
    ...
    let parsed: types::conversation::ChatRequest =
...
fn test_conversation_type_values() {
    ...
    use types::conversation::ConversationType;
...
fn test_chat_type_values() {
    ...
    use types::conversation::ChatType;
...
fn test_chat_response_fields_match() {
    ...
    let parsed: types::conversation::ChatResponse =
...
fn test_chat_response_camel_case() {
    use types::conversation::{ChatRequest, ChatResponse, ChatType, ConversationType};
...
fn test_error_response_fields_match() {
    ...
    let parsed: types::conversation::ErrorResponse =
...
fn test_session_key_format_matches() {
    ...
    use types::conversation::{ChatType, ConversationType, SessionKey};
...
fn test_is_chat_request_equivalent() {
    ...
    assert!(serde_json::from_value::<types::conversation::ChatRequest>(valid_chat).is_ok());

    // Valid 'message' type should parse
    assert!(
        serde_json::from_value::<types::conversation::ChatRequest>(valid_message).is_ok()
    );

    // Invalid type should fail
    assert!(
        serde_json::from_value::<types::conversation::ChatRequest>(invalid_type).is_err()
    );

    // Missing required fields should fail
    assert!(
        serde_json::from_value::<types::conversation::ChatRequest>(missing_fields).is_err()
    );
}
...
fn test_attachment_fields_match() {
    ...
    let parsed: types::conversation::Attachment =
...
fn test_response_metadata_fields_match() {
    ...
    let parsed: types::conversation::ResponseMetadata =
