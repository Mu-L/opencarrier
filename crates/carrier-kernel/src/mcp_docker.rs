...
use carrier_types::mcp_manifest::{McpDockerInstall, McpInstallConfig, McpServerManifest};
use std::path::Path;
...
fn build_compose_yaml(
    ...
    let container_name = if install.container_name.is_empty() {
        format!("carrier-mcp-{}", service_name)
    } else {
    ...
    Ok(format!(
        r#"# Auto-generated by carrier mcp install — do not edit manually.
services:
  {service_name}:
    image: {image}
